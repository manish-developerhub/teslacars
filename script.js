...
function SlideAside(props) {
  ...
  return  React.createElement(
    ...
    React.createElement(
      "h1",
      { className: "tesla-slide-aside_wholename" } ,
    ...
    React.createElement(
      TransitionGroup,
      { className: "tesla-slide-aside_desc" } /*#PURE_*/,
      React.createElement(
        CSSTransition,
        {
          key: activeCar.desc,
    ...
    React.createElement(
      "div",
      { className: "tesla-slide-aside_button" } ,
      React.createElement(
        "button",
        { className: "button" },
        "Reserve now",
...
class SlideParams extends React.Component {
  ...
  render() {
    ...
    return  React.createElement(
      ...
      React.createElement(
        "ul",
        { className: "tesla-slide-params_list" } ,
        React.createElement(
          "li",
          { className: "tesla-slide-params_item" } ,
          React.createElement(
            "div",
            { className: "tesla-slide-params_wrapper" } ,
            React.createElement(
              "span",
...
class Slider extends React.Component {
  ...
  render() {
    return  React.createElement(
      ...
      React.createElement(
        "div",
        { className: "tesla-slider_scroll" } /*#PURE_*/,
...
function Header() {
  return  React.createElement(
    ...
    React.createElement(
      "div",
      { className: "tesla-header_logo" } ,
      React.createElement("img", { src: logoTesla, alt: "" }),
    ) ,

    React.createElement(
      "div",
      { className: "tesla-header_nav" } /*#PURE_*/,
